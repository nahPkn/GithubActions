[![Run App TommyPhan](https://github.com/nahPkn/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/nahPkn/GithubActions/actions/workflows/run-app.yaml)
